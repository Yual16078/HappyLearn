...
import com.example.happylearn.utils.PhotoUtils;
import com.example.happylearn.utils.UriUtils;
        ...
        switch (requestCode) {
            case TAKE_PHOTO:
                if (resultCode == RESULT_OK) {
                    Intent intent = PhotoUtils.startPhotoZoom(imageUri, imageUri, 2000, 2000);
